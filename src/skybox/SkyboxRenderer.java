...
private static final float SIZE = 600f;
	...
	public void render(Camera camera, float r, float g, float b, boolean isNight) {
		shader.start();
		shader.loadViewMatrix(camera);
		shader.loadFogColour(r, g, b);
		GL30.glBindVertexArray(cube.getVaoID());
		GL20.glEnableVertexAttribArray(0);
		bindTextures(isNight);
	...
	public void render(OverheadCamera camera, float r, float g, float b, boolean isNight) {
		shader.start();
		shader.loadViewMatrix(camera);
		shader.loadFogColour(r, g, b);
		GL30.glBindVertexArray(cube.getVaoID());
	...
	private void bindTextures(boolean isNight) {
