...
public class MenuRenderer extends MenuController {
	...
	public MenuRenderer() {
		texts.add(new GUIText(textRenderer, Mift.NAME + " Alpha Build " + Mift.RELEASE + "." + Mift.BUILD, 2.5f, FontHolder.getCandara(), new Vector2f(0.35f, 0f), 0.35f, ALIGNMENT.LEFT));
		texts.get(0).setColor(100, 0, 200);
		texts.add(new GUIText(textRenderer, "New Game", 1f, FontHolder.getCandara(), new Vector2f(0.47f, 0.35f), 0.35f, ALIGNMENT.LEFT));
