...
public class SettingsRenderer {
	...
	public SettingsRenderer() {
		texts.add(new GUIText(Mift.NAME + " " + Mift.RELEASE_TITLE + " Build " + Mift.RELEASE + "." + Mift.BUILD + " Settings", 2.5f, FontHolder.getFreestyle(), new Vector2f(0.25f, 0f), 0.55f, ALIGNMENT.LEFT));
		texts.get(0).setColor(100, 0, 200);
		
		texts.add(new GUIText("Fullscreen [" + SettingHolder.get("cg_fullscreened").getValueDebug()+ "]",
				1f, FontHolder.getFreestyle(), new Vector2f(0.27f, 0.15f), 0.35f, ALIGNMENT.LEFT));
				texts.get(1).setColor(255, 100, 100);
		texts.add(new GUIText("Anisotropic Filtering [" + SettingHolder.get("cg_anisotropic_filtering").getValueDebug() + "]",
				1f, FontHolder.getFreestyle(), new Vector2f(0.27f, 0.25f), 0.35f, ALIGNMENT.LEFT));
				texts.get(2).setColor(255, 255, 255);
		texts.add(new GUIText("Antialiasing Filtering [" + SettingHolder.get("cg_antialiasing_filtering").getValueDebug() + "]",
				1f, FontHolder.getFreestyle(), new Vector2f(0.27f, 0.35f), 0.35f, ALIGNMENT.LEFT));
				texts.get(3).setColor(255, 255, 255);
		texts.add(new GUIText("Draw FPS [" + SettingHolder.get("cg_fps").getValueDebug() + "]",
				1f, FontHolder.getFreestyle(), new Vector2f(0.27f, 0.45f), 0.35f, ALIGNMENT.LEFT));
				texts.get(4).setColor(255, 255, 255);
		texts.add(new GUIText("Theater Mode [" + SettingHolder.get("cg_theatrical").getValueDebug() + "]",
				1f, FontHolder.getFreestyle(), new Vector2f(0.27f, 0.55f), 0.35f, ALIGNMENT.LEFT));
				texts.get(5).setColor(255, 255, 255);
		texts.add(new GUIText("Post Processing Effects [" + SettingHolder.get("cg_post_processing").getValueDebug() + "]",
				1f, FontHolder.getFreestyle(), new Vector2f(0.5f, 0.15f), 0.35f, ALIGNMENT.LEFT));
				texts.get(6).setColor(255, 255, 255);
		texts.add(new GUIText("Myo Armband Connection [" + SettingHolder.get("cp_myo_enabled").getValueDebug() + "]",
				1f, FontHolder.getFreestyle(), new Vector2f(0.5f, 0.25f), 0.35f, ALIGNMENT.LEFT));
				texts.get(7).setColor(255, 255, 255);
		texts.add(new GUIText("Quality [" + SettingHolder.get("cg_quality").getQualityDebug() + "]",
				1f, FontHolder.getFreestyle(), new Vector2f(0.5f, 0.35f), 0.35f, ALIGNMENT.LEFT));
				texts.get(8).setColor(255, 255, 255);
		texts.add(new GUIText("VSync [" + SettingHolder.get("cg_vsync").getValueDebug() + "]",
				1f, FontHolder.getFreestyle(), new Vector2f(0.5f, 0.45f), 0.35f, ALIGNMENT.LEFT));
