...
public class SettingHolder {
	...
	public SettingHolder() {
		...
		settings.add(new Setting("cg_resolution_w",				"Render Width",				"Set the screens render resolution for width", 								1920, 		0, 7, 1024, 1920));
		settings.add(new Setting("cg_resolution_h",				"Render Height",			"Set the screens render resolution for height",								1200, 		0, 8, 640, 1200));
		settings.add(new Setting("cg_vsync", 					"VSync", 					"Toggle Vertical Syncing To Avoid Screen Tearing", 							true, 		0, 9));
		settings.add(new Setting("cg_fov", 						"FOV", 						"Set The Field Of View The Camera Renders At", 								70, 		0, 10, 70, 110));
